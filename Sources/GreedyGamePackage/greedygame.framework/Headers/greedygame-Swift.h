...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="greedygame",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10greedygame15FloatRatingView")
...
SWIFT_PROTOCOL("_TtP10greedygame23FloatRatingViewDelegate_")
@protocol FloatRatingViewDelegate
@optional
...
@interface GreedyGameAgent (SWIFT_EXTENSION(greedygame))
@end


SWIFT_CLASS("_TtCC10greedygame15GreedyGameAgent7Builder")
...
SWIFT_CLASS("_TtC10greedygame14PrivacyOptions")
